...
{
    public class AgregarProductoPopupViewModel : ViewModelBase
    {
        #region Vars
        private static string TAG = nameof(AgregarProductoPopupViewModel);
        #endregion
        ...
        #region Contructor
        public AgregarProductoPopupViewModel(INavigationService navigationService, IUserDialogs userDialogsService, IConnectivity connectivity) : base(navigationService, userDialogsService, connectivity)
        {
